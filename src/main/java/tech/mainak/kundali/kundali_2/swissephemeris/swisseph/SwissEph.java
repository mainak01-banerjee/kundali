...
*/
package tech.mainak.kundali.kundali_2.swissephemeris.swisseph;
...
// NBT
  ...
  */
  public void swe_set_ephe_path(String path) {
    ...
    System.out.println("Deleting all planetary Data");
    swe_close();
    System.out.println("Deleted all existing Planetary data");
...
// meaningful anyway...
    ...
    if (swed.fidat[SwephData.SEI_FILE_MOON].fptr != null) {
      ...
      System.out.println("Opened Lunar Ephimeris");
    }
  }
...
//        Trace.level--;
////#endif /* TRACE0 */
        System.out.println("File:"+fname+"File Read Compete from Path: "+ephepath);
        return sfp;
